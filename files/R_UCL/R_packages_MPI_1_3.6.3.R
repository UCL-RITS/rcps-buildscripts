...
install.packages ("Rmpi", lib=mainLib, repos=repros, configure.args="--with-Rmpi-include=/shared/ucl/apps/openmpi/3.1.5/gnu-9.2.0/include --with-Rmpi-libpath=/shared/ucl/apps/openmpi/3.1.5/gnu-9.2.0/lib --with-Rmpi-type=OPENMPI");
